         ...
         <div className="container mx-auto min-h-screen flex justify-center items-center flex-col gap-6 p-4">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 w-full">
               <Link href={`/quiz/htmlcss`}>
                  <button
                     className="py-2 px-6 text-lg font-semibold bg-white text-black rounded-full cursor-pointer shadow-lg hover:bg-[var(--primary-color-2)] transition w-full md:w-fit">
                     HTML e CSS
                  </button>
               </Link>
